...
router.get("/", optionalAuthenticate, parseIdParam("articleId"), c.listForArticle);

router.post("/", authenticate, parseIdParam("articleId"), validateCreateComment, c.createForArticle);
