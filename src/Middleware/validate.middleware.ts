...
export const validateArticleCreate = (req: Request, res: Response, next: NextFunction) => {
...
export const validateCommentCreateForProduct = (req: Request, res: Response, next: NextFunction) => {
...
export const validateCommentCreateForArticle = (req: Request, res: Response, next: NextFunction) => {
  const { content } = req.body;
