import { NewNotificationEntity, PersistNotificationEntity } from "../../../application/command/entity/notification.entity";
...
export class NotificationCommandRepo extends BaseRepo implements INotificationCommandRepo {
  async save(
