import { PersistArticleEntity, NewArticleEntity } from "../../../../application/command/entity/article.entity";
import { IArticleCommandRepo } from "../../../../application/port/repo/command/article/article.command.repo.interface";
import { ArticleKeys, Sort } from "../../../../types/query";
import { ArticleMapper } from "../../../mapper/article.mapper";
import { BaseRepo } from "../../base.repo";

export class ArticleCommandRepo extends BaseRepo implements IArticleCommandRepo {
