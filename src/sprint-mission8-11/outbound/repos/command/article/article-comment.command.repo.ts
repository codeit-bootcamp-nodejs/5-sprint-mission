import { PersitstArticleCommentEntity, NewArticleCommentEntity } from "../../../../application/command/entity/comment/article-comment.entity";
import { IArticleCommentCommandRepo } from "../../../../application/port/repo/command/article/article-comment.command.repo.interface";
import { CommentKeys, Sort } from "../../../../types/query";
import { ArticleCommentMapper } from "../../../mapper/comment/article.comment.mapper";
import { BaseRepo } from "../../base.repo";

export class ArticleCommentCommandRepo
  extends BaseRepo
  implements IArticleCommentCommandRepo
{
