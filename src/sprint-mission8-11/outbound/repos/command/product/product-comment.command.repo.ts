import { PersitstProductCommentEntity, NewProductCommentEntity } from "../../../../application/command/entity/comment/product-comment.entity";
import { IProductCommentCommandRepo } from "../../../../application/port/repo/command/product/product-comment.command.repo.interface";
import { CommentKeys, Sort } from "../../../../types/query";
import { ProductCommentMapper } from "../../../mapper/comment/product.comment.mapper";
import { BaseRepo } from "../../base.repo";

export class ProductCommentCommandRepo
  extends BaseRepo
  implements IProductCommentCommandRepo
{
