...
import { PersistProductEntity, NewProductEntity } from "../../../../application/command/entity/product/product.entity";
...
export class ProductCommandRepo extends BaseRepo implements IProductCommandRepo {
