...
import { IProductCommentCommandRepo } from "../../../port/repo/command/product/product-comment.command.repo.interface";
...
export class ProductCommentCommandService {
  constructor(
    private readonly _productCommentRepo: IProductCommentCommandRepo,
