...
import { IProductCommandRepo } from "../../../port/repo/command/product/product.command.repo.interface";
import { ITagCommandRepo } from "../../../port/repo/command/tag.command.repo.interface";
import { INotificationCommandRepo } from "../../../port/repo/command/notification.command.repo.interface";
import { IUserLikesProductCommandRepo } from "../../../port/repo/command/like/user-likes-product.command.repo.interface";
...
export class ProductCommandService {
  constructor(
    private readonly _productRepo: IProductCommandRepo,
    private readonly _userLikesproductRepo: IUserLikesProductCommandRepo,
    private readonly _tagRepo: ITagCommandRepo,
