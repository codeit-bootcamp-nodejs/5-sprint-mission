...
SELECT *
FROM orders
WHERE date = DATE '2025-03-12' AND time < TIME '12:00:00';
...
FROM orders AS o JOIN order_details AS od ON o.id = od.order_id
GROUP BY o.date;
...
FROM pizzas AS p JOIN order_details AS od ON p.id = od.pizza_id
...
WHERE o.date >= DATE '2025-03-01' AND o.date < DATE '2025-04-01'
GROUP BY o.date;
