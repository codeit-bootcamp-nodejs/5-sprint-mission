...
describe("ProductService Unit Test", () => {
  ...
  beforeEach(() => {
    ...
    notificationService = new NotificationService({} as any, {} as any) as jest.Mocked<NotificationService>;
  ...
  test("상품 생성 로직 테스트 (createProduct)", async () => {
    ...
    productRepository.createProduct.mockResolvedValue(mockCreatedProduct as any);
